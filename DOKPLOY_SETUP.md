...
(لا تحتاج أي Build Args لهذا التطبيق)
...
**أضف هذه المتغيرات في "Environment Variables" في تطبيقك على Dokploy:**
...
2. أضف رابط موقعك في `Supabase → Authentication → URL Configuration → Redirect URLs` (مثل `https://your-domain.com/*`)
