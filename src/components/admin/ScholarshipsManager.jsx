...
const ScholarshipsManager = () => {
  ...
  useEffect(() => {
    setTranslations(editingScholarship?.translations || {})
  }, [editingScholarship])
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      content: contentHtml,
      seoTitle: tBase.seoTitle || editingScholarship?.seoTitle || '',
      seoDescription: tBase.seoDescription || editingScholarship?.seoDescription || '',
      translations,
    }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onBlur={async (e) => { const draft = { id: editingScholarship?.id, translations: { ...translations, [loc]: { ...(translations[loc]||{}), seoTitle: e.target.value } } }; await saveDraft('scholarship', draft); }}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        onBlur={async (e) => { const draft = { id: editingScholarship?.id, translations: { ...translations, [loc]: { ...(translations[loc]||{}), seoDescription: e.target.value } } }; await saveDraft('scholarship', draft); }}
